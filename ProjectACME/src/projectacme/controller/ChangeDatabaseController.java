...
public class ChangeDatabaseController {
    ...
    public ChangeDatabaseController(InterfaceAccessDataBase accessDataBaseView) {
        System.out.println("ChangeAccessDatabaseController initialized");
    ...
    private void initController() {
        accessDataBaseView.getTextButton().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                try {
                    FileManagement.SetNewConnectionDatabase(
